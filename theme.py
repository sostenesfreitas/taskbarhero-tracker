...
QLabel#LinhaNome {{ color: {TEXTO_OSSO}; font-family: 'Departure Mono'; font-size: 12px; }}
QLabel#LinhaStage {{ color: {TEXTO_MUDO}; font-family: 'Departure Mono'; font-size: 11px; }}
